...
import 'package:ideafront/Investor/subscriptionscreen/paymentSuccessfull.dart';
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: SizedBox(
                      width: 90.0,
                      height: 90.0,
                      child: Image.asset('assets/icons/mastertick.png'),
                    ),
                  ),
                  GestureDetector(
                    onTap: () {
                      // Handle tap gesture for the third image
                      Get.to(() => const Amx());
                    },
                    child: SizedBox(
                      width: 48.0,
