                    ...
                    children: [
                      const Row(
                        children: [
                          CircleAvatar(
                            ...
                            radius: 20,
                            backgroundImage: AssetImage('assets/images/4.jpg'), // Replace with the profile photo
                          ),
                          SizedBox(width: 8.0),
                          Text(
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: homeIdeasList.length, // Replace with actual photo count
                          itemBuilder: (context, index) {
                            return Container(
                              width: 300.0,
                              margin: const EdgeInsets.only(right: 8.0),
                              color: Colors.grey.shade300,
                              child: Image.asset(homeIdeasList[index],fit: BoxFit.fill,), // Replace with photo
      ...
      children: [
        Row(
          children: [
            ...
            const Text('16 likes',style: TextStyle(fontWeight: FontWeight.bold),),
          ],
        ),
        Row(
          children: [
            ...
            IconButton(onPressed: (){}, icon: const Icon(Icons.send_rounded),color: Colors.blueGrey,),
            IconButton(
                      ...
                      content: Column(
                        ...
                        children: [
                          ...
                          TextField(
                            onChanged: (value) {
                              setState(() {
                                // Update the isReported value based on the text field value
                                isReported = value.isNotEmpty;
                              });
                            },
                      ...
                      actions: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            String description =
                                'Get the description from TextField';
